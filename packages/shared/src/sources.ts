...
export const SOURCE_SPECS: SourceSpec[] = [
  ...
  { venture: 'crypto', label: "Handelslogboek van afgesloten trades", file: 'trades.csv', required: ['datum', 'munt', 'richting', 'resultaat_r'], dates: ['datum'], numbers: ['resultaat_r', 'inzet'], note: "resultaat in R (winst gedeeld door risico), niet in geld" },
  ...
  { venture: 'equities', label: "Handelslogboek van afgesloten trades", file: 'trades.csv', required: ['datum', 'ticker', 'richting', 'resultaat_r'], dates: ['datum'], numbers: ['resultaat_r', 'inzet'], note: "resultaat in R (winst gedeeld door risico), niet in geld" },
